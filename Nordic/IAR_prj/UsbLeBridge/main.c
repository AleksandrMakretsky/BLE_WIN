...
#define DEVICE_NAME                     "nRF DS Bridg"          /*< Name of device used for advertising. */
#define MANUFACTURER_NAME               "nRF DS Server"         /**< Manufacturer. Passed to Device Information Service. */
